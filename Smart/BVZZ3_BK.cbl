      ...
      *
       2010-READ-FILE.
      *
      * READ ITEM FILE TO GET SALE UNIT AND AREA CODE 
           IF IS-READ-ITEM                 = '0'
               ...
               ELSE
                  ...
                  MOVE BEGIN               TO AGLF-FUNCTION
                  MOVE '1'                 TO IS-READ-ITEM
               END-IF
           END-IF.
      ...
      *
           ...
           AND AGLF-TSALESUNT         NOT = TVZZ3-TSALESUNT  
      ...
      *********************
       3010-UPDATE.
           ...
           PERFORM 2600-ASIGN-VALUE-TO-ZZZ2PF.
